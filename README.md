...
-- Selecionar e Teleportar para o jogador
Tabs.Troll:AddSection("Teleporte e Spectate")
    ...
    Callback = function(playerName)
        ...
        if selectedPlayer then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                ...
                Text = "Você foi teleportado para " .. selectedPlayer.Name,
                Duration = 5
            })
        end
    end
...
Tabs.Troll:AddButton({
    ...
    Callback = function()
        if spectatingPlayer then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "Modo Spectator Ativado",
                Text = "Agora você está espectando " .. spectatingPlayer.Name,
                Duration = 5
            })
        else
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "Erro",
                Text = "Selecione um jogador para spectar!",
                Duration = 5
            })
        end
    end
